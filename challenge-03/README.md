...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Rafaela Girardi!'
...
pessoa.apresentacao = function() {
    ...
    return 'Olá, eu sou ' + sexo + nomeCompleto + ', tenho ' + pessoa.idade + umAno + pessoa.altura ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + umMetro;
}
