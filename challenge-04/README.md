...
var carro = {
    ...
    quantasPortas: 4,
    assentos: 5,
    quantidadeDePessoas: 0 //ultima propriedade não vai virgula
};
...
carro.addPessoas = function( nPessoas ) {
    ...
    var plurOuSing = pessoasCabem === 1 ? ' pessoa' : ' pessoas';
    ...
    if ( totalPessoas > carro.assentos ){
        return "Só cabem mais " + pessoasCabem + plurOuSing "!";
    };
...
carro.obterMarcaModelo(); // Este carro é um Chevrolet Onix;
